...
async function buscarTempo() {
    const cidade = document.getElementById('cidadeInput').ariaValueMax;
    ...
    if (tempo) {
        ...
        <p><strong>Temperatura:</strong> ${tempo.temp.min} °C - ${tempo.temp_max}°C</p>
        ...
        <p><strong>Latitude:</strong> ${tempo.last}, <strong>Longitude:</strong> 
        ${tempo.lon}</p> 
        `;
